...
import type { Task } from "@/src/modules/quick-task"
  ...
  return (
    <div className="flex h-screen bg-background">
      <div
        ...
        style={{ width: isSidebarLocked || isHovering ? "240px" : "2px" }}
      ...
      >
        ...
        />
        {!isSidebarLocked && !isHovering && <div className="absolute top-0 left-0 w-2 h-screen cursor-pointer" />}
      </div>
      <MainContent activeItem={activeItem} onTaskSelect={setSelectedTask} />
